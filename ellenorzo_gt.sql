...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Jan 31. 09:11
...
CREATE TABLE `oktato` (
  ...
  `v_nev` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
  `k_nev` varchar(255) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
--
-- Tábla szerkezet ehhez a táblához `order_by`
--

CREATE TABLE `order_by` (
  `id` int(10) UNSIGNED NOT NULL,
  `vnev` varchar(50) COLLATE utf8_hungarian_ci NOT NULL,
  `knev1` varchar(50) COLLATE utf8_hungarian_ci NOT NULL,
  `knev2` varchar(50) COLLATE utf8_hungarian_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;

--
-- A tábla adatainak kiíratása `order_by`
--
...
CREATE TABLE `tantargy` (
  ...
  `tantargy_neve` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
  `oktato_id` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
CREATE TABLE `tanulo` (
  ...
  `v_nev` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
  `k_nev` varchar(255) COLLATE utf8_hungarian_ci NOT NULL,
  `om_azonosito` varchar(20) COLLATE utf8_hungarian_ci NOT NULL,
  `szul_hely` varchar(15) COLLATE utf8_hungarian_ci NOT NULL,
...
--
-- AUTO_INCREMENT a táblához `order_by`
--
ALTER TABLE `order_by`
